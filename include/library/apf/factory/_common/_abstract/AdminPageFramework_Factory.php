...
abstract class ShortcodeDirectives_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'ShortcodeDirectives_AdminPageFramework_Form_', 'oPageLoadInfo' => 'ShortcodeDirectives_AdminPageFramework_PageLoadInfo_', 'oResource' => 'ShortcodeDirectives_AdminPageFramework_Resource_', 'oHelpPane' => 'ShortcodeDirectives_AdminPageFramework_HelpPane_', 'oLink' => 'ShortcodeDirectives_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'ShortcodeDirectives_AdminPageFramework_Debug', 'oUtil' => 'ShortcodeDirectives_AdminPageFramework_FrameworkUtility', 'oMsg' => 'ShortcodeDirectives_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(ShortcodeDirectives_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return ShortcodeDirectives_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class ShortcodeDirectives_AdminPageFramework_Factory_Model extends ShortcodeDirectives_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class ShortcodeDirectives_AdminPageFramework_Factory_View extends ShortcodeDirectives_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new ShortcodeDirectives_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class ShortcodeDirectives_AdminPageFramework_Factory_Controller extends ShortcodeDirectives_AdminPageFramework_Factory_View {
...
abstract class ShortcodeDirectives_AdminPageFramework_Factory extends ShortcodeDirectives_AdminPageFramework_Factory_Controller {
}
