...
abstract class ShortcodeDirectives_AdminPageFramework_Property_Base extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'shortcode-directives' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aShortcodeDirectives_AdminPageFramework'])) {
            $GLOBALS['aShortcodeDirectives_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => ShortcodeDirectives_AdminPageFramework_Registry::NAME, 'sURI' => ShortcodeDirectives_AdminPageFramework_Registry::URI, 'sScriptName' => ShortcodeDirectives_AdminPageFramework_Registry::NAME, 'sLibraryName' => ShortcodeDirectives_AdminPageFramework_Registry::NAME, 'sLibraryURI' => ShortcodeDirectives_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => ShortcodeDirectives_AdminPageFramework_Registry::getVersion(), 'sDescription' => ShortcodeDirectives_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => ShortcodeDirectives_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => ShortcodeDirectives_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => ShortcodeDirectives_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => ShortcodeDirectives_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new ShortcodeDirectives_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
