...
class ShortcodeDirectives_AdminPageFramework_Form_View___DebugInfo extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='shortcode-directives-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
