...
class ShortcodeDirectives_AdminPageFramework_Form_View___Generate_FieldTagID extends ShortcodeDirectives_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class ShortcodeDirectives_AdminPageFramework_Form_View___Generate_FieldInputID extends ShortcodeDirectives_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
