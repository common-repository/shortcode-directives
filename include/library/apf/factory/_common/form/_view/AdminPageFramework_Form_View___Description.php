...
class ShortcodeDirectives_AdminPageFramework_Form_View___Description extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'shortcode-directives-form-element-description';
