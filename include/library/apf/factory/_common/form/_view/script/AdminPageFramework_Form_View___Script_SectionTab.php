...
class ShortcodeDirectives_AdminPageFramework_Form_View___Script_SectionTab extends ShortcodeDirectives_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.shortcode-directives-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='shortcode-directives-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
