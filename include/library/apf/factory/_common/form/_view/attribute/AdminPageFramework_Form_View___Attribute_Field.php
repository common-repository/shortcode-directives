...
abstract class ShortcodeDirectives_AdminPageFramework_Form_View___Attribute_Base extends ShortcodeDirectives_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class ShortcodeDirectives_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends ShortcodeDirectives_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class ShortcodeDirectives_AdminPageFramework_Form_View___Attribute_Field extends ShortcodeDirectives_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    public $sContext = 'field';
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " shortcode-directives-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "shortcode-directives-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' shortcode-directives-subfield', ''));
    }
}
