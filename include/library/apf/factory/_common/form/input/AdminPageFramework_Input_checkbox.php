...
abstract class ShortcodeDirectives_AdminPageFramework_Input_Base extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'shortcode-directives-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'shortcode-directives-input-label-string',),);
...
class ShortcodeDirectives_AdminPageFramework_Input_checkbox extends ShortcodeDirectives_AdminPageFramework_Input_Base {
