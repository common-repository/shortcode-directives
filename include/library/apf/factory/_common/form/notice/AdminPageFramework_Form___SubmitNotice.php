...
class ShortcodeDirectives_AdminPageFramework_Form___SubmitNotice extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new ShortcodeDirectives_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new ShortcodeDirectives_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
