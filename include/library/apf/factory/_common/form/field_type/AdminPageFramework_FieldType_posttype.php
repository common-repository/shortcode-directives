...
class ShortcodeDirectives_AdminPageFramework_FieldType_checkbox extends ShortcodeDirectives_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.shortcode-directives-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.shortcode-directives-checkbox-label {margin-top: 0.1em;}.shortcode-directives-field input[type='checkbox' ] {margin-right: 0.5em;} .shortcode-directives-field-checkbox .shortcode-directives-input-label-container {padding-right: 1em;}.shortcode-directives-field-checkbox .shortcode-directives-input-label-string{display: inline; }";
    }
...
class ShortcodeDirectives_AdminPageFramework_FieldType_posttype extends ShortcodeDirectives_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".shortcode-directives-field input[type='checkbox'] {margin-right: 0.5em;} .shortcode-directives-field-posttype .shortcode-directives-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
