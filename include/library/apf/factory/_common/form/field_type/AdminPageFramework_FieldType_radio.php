...
class ShortcodeDirectives_AdminPageFramework_FieldType_radio extends ShortcodeDirectives_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".shortcode-directives-field input[type='radio'] {margin-right: 0.5em;} .shortcode-directives-field-radio .shortcode-directives-input-label-container {padding-right: 1em;} .shortcode-directives-field-radio .shortcode-directives-input-container {display: inline;} .shortcode-directives-field-radio .shortcode-directives-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.shortcode-directives-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
