...
class ShortcodeDirectives_AdminPageFramework_FieldType_submit extends ShortcodeDirectives_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".shortcode-directives-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'shortcode-directives-input-label-container' . ' shortcode-directives-input-button-container' . ' shortcode-directives-input-container',);
    }
...
class ShortcodeDirectives_AdminPageFramework_FieldType_export extends ShortcodeDirectives_AdminPageFramework_FieldType_submit {
