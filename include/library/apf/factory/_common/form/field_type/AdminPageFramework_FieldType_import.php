...
class ShortcodeDirectives_AdminPageFramework_FieldType_import extends ShortcodeDirectives_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".shortcode-directives-field-import input {margin-right: 0.5em;}.shortcode-directives-field-import label,.form-table td fieldset.shortcode-directives-fieldset .shortcode-directives-field-import label { display: inline; }";
    }
