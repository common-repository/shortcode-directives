...
class ShortcodeDirectives_AdminPageFramework_Form_Model___Modifier_SortInput extends ShortcodeDirectives_AdminPageFramework_Form_Model___Modifier_Base {
    public $aInput = array();
