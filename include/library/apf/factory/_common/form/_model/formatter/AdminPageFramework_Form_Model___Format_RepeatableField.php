...
class ShortcodeDirectives_AdminPageFramework_Form_Model___Format_RepeatableSection extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : ShortcodeDirectives_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class ShortcodeDirectives_AdminPageFramework_Form_Model___Format_RepeatableField extends ShortcodeDirectives_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
