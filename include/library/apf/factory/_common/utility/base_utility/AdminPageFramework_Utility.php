...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        ShortcodeDirectives_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return ShortcodeDirectives_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        ShortcodeDirectives_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return ShortcodeDirectives_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        ShortcodeDirectives_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        ShortcodeDirectives_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        ShortcodeDirectives_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'ShortcodeDirectives_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_VariableType extends ShortcodeDirectives_AdminPageFramework_Utility_Deprecated {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_String extends ShortcodeDirectives_AdminPageFramework_Utility_VariableType {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_Array extends ShortcodeDirectives_AdminPageFramework_Utility_String {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_ArrayGetter extends ShortcodeDirectives_AdminPageFramework_Utility_Array {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_ArraySetter extends ShortcodeDirectives_AdminPageFramework_Utility_ArrayGetter {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_Path extends ShortcodeDirectives_AdminPageFramework_Utility_ArraySetter {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_URL extends ShortcodeDirectives_AdminPageFramework_Utility_Path {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_File extends ShortcodeDirectives_AdminPageFramework_Utility_URL {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_SystemInformation extends ShortcodeDirectives_AdminPageFramework_Utility_File {
...
abstract class ShortcodeDirectives_AdminPageFramework_Utility_HTMLAttribute extends ShortcodeDirectives_AdminPageFramework_Utility_SystemInformation {
...
class ShortcodeDirectives_AdminPageFramework_Utility extends ShortcodeDirectives_AdminPageFramework_Utility_HTMLAttribute {
