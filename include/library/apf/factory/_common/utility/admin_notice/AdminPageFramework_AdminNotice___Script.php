...
class ShortcodeDirectives_AdminPageFramework_AdminNotice___Script extends ShortcodeDirectives_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.shortcode-directives-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='shortcode-directives-admin-notice-animation-container'></div>" );
