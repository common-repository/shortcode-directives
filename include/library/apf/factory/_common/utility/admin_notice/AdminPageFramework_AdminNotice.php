...
class ShortcodeDirectives_AdminPageFramework_AdminNotice extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'shortcode-directives-settings-notice-message', 'shortcode-directives-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new ShortcodeDirectives_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
