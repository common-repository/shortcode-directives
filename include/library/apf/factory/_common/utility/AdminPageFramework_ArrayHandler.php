...
class ShortcodeDirectives_AdminPageFramework_FrameworkUtility extends ShortcodeDirectives_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = ShortcodeDirectives_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return ShortcodeDirectives_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class ShortcodeDirectives_AdminPageFramework_ArrayHandler extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    public $aData = array();
