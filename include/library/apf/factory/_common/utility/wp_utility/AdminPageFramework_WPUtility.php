...
class ShortcodeDirectives_AdminPageFramework_WPUtility_URL extends ShortcodeDirectives_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(ShortcodeDirectives_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(ShortcodeDirectives_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = ShortcodeDirectives_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_HTML extends ShortcodeDirectives_AdminPageFramework_WPUtility_URL {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_Page extends ShortcodeDirectives_AdminPageFramework_WPUtility_HTML {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_Hook extends ShortcodeDirectives_AdminPageFramework_WPUtility_Page {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_File extends ShortcodeDirectives_AdminPageFramework_WPUtility_Hook {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_Option extends ShortcodeDirectives_AdminPageFramework_WPUtility_File {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_Meta extends ShortcodeDirectives_AdminPageFramework_WPUtility_Option {
    ...
    static public function getMetaDataByKeys($oSubject, $aKeys, $sMetaType = 'post') {
        $_aSavedMeta = array();
        if (!$oSubject) {
            return $_aSavedMeta;
        }
        ...
        foreach ($aKeys as $_sKey) {
            $_aSavedMeta[$_sKey] = call_user_func_array($_sFunctionName, array($oSubject, $_sKey, true));
        }
        return $_aSavedMeta;
    }
}
class ShortcodeDirectives_AdminPageFramework_WPUtility_SiteInformation extends ShortcodeDirectives_AdminPageFramework_WPUtility_Meta {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility_SystemInformation extends ShortcodeDirectives_AdminPageFramework_WPUtility_SiteInformation {
...
class ShortcodeDirectives_AdminPageFramework_WPUtility extends ShortcodeDirectives_AdminPageFramework_WPUtility_SystemInformation {
