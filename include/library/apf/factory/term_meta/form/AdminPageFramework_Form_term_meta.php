...
class ShortcodeDirectives_AdminPageFramework_Form_term_meta extends ShortcodeDirectives_AdminPageFramework_Form_Meta {
    public $sStructureType = 'term_meta';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new ShortcodeDirectives_AdminPageFramework_Form_View___CSS_term_meta;
    ...
    public function get() {
        ...
        $_sClassSelectors = 'shortcode-directives-form-table-term_meta' . $_sAddNewTerm;
        return '<tr class="shortcode-directives-form-table-outer-row-term_meta">' . '<td colspan=2>' . '<table class="' . $_sClassSelectors . '">' . '<tbody>' . '<tr>' . '<td>' . $_oFormTables->get() . '</td>' . '</tr>' . '</tbody>' . '</table>' . '</td>' . '</tr>';
    }
}
