...
abstract class ShortcodeDirectives_AdminPageFramework_TermMeta_Router extends ShortcodeDirectives_AdminPageFramework_TaxonomyField_Controller {
}
abstract class ShortcodeDirectives_AdminPageFramework_TermMeta_Model extends ShortcodeDirectives_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new ShortcodeDirectives_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class ShortcodeDirectives_AdminPageFramework_TermMeta_View extends ShortcodeDirectives_AdminPageFramework_TermMeta_Model {
...
abstract class ShortcodeDirectives_AdminPageFramework_TermMeta_Controller extends ShortcodeDirectives_AdminPageFramework_TermMeta_View {
}
abstract class ShortcodeDirectives_AdminPageFramework_TermMeta extends ShortcodeDirectives_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'shortcode-directives') {
