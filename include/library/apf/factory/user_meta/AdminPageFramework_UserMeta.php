...
abstract class ShortcodeDirectives_AdminPageFramework_UserMeta_Router extends ShortcodeDirectives_AdminPageFramework_Factory {
...
abstract class ShortcodeDirectives_AdminPageFramework_UserMeta_Model extends ShortcodeDirectives_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new ShortcodeDirectives_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class ShortcodeDirectives_AdminPageFramework_UserMeta_View extends ShortcodeDirectives_AdminPageFramework_UserMeta_Model {
...
abstract class ShortcodeDirectives_AdminPageFramework_UserMeta_Controller extends ShortcodeDirectives_AdminPageFramework_UserMeta_View {
...
abstract class ShortcodeDirectives_AdminPageFramework_UserMeta extends ShortcodeDirectives_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'shortcode-directives') {
