...
abstract class ShortcodeDirectives_AdminPageFramework_TaxonomyField_Router extends ShortcodeDirectives_AdminPageFramework_Factory {
...
abstract class ShortcodeDirectives_AdminPageFramework_TaxonomyField_Model extends ShortcodeDirectives_AdminPageFramework_TaxonomyField_Router {
...
abstract class ShortcodeDirectives_AdminPageFramework_TaxonomyField_View extends ShortcodeDirectives_AdminPageFramework_TaxonomyField_Model {
...
abstract class ShortcodeDirectives_AdminPageFramework_TaxonomyField_Controller extends ShortcodeDirectives_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class ShortcodeDirectives_AdminPageFramework_TaxonomyField extends ShortcodeDirectives_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'shortcode-directives') {
