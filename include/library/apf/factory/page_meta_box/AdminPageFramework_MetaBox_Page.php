...
abstract class ShortcodeDirectives_AdminPageFramework_MetaBox_Page extends ShortcodeDirectives_AdminPageFramework_PageMetaBox {
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'shortcode-directives') {
        ...
        $this->oUtil->showDeprecationNotice('The class, ' . __CLASS__ . ',', 'ShortcodeDirectives_AdminPageFramework_PageMetaBox');
    }
}
