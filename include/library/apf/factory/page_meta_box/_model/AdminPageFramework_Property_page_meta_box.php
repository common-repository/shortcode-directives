...
class ShortcodeDirectives_AdminPageFramework_Property_page_meta_box extends ShortcodeDirectives_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'shortcode-directives', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aShortcodeDirectives_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aShortcodeDirectives_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aShortcodeDirectives_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aShortcodeDirectives_AdminPageFramework', 'aPageClasses'));
