...
abstract class ShortcodeDirectives_AdminPageFramework_MetaBox_Router extends ShortcodeDirectives_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'shortcode-directives') {
...
abstract class ShortcodeDirectives_AdminPageFramework_MetaBox_Model extends ShortcodeDirectives_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'shortcode-directives') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new ShortcodeDirectives_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class ShortcodeDirectives_AdminPageFramework_MetaBox_View extends ShortcodeDirectives_AdminPageFramework_MetaBox_Model {
...
abstract class ShortcodeDirectives_AdminPageFramework_MetaBox_Controller extends ShortcodeDirectives_AdminPageFramework_MetaBox_View {
...
abstract class ShortcodeDirectives_AdminPageFramework_MetaBox extends ShortcodeDirectives_AdminPageFramework_MetaBox_Controller {
