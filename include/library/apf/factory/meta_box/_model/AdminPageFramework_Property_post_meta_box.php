...
class ShortcodeDirectives_AdminPageFramework_Property_post_meta_box extends ShortcodeDirectives_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'shortcode-directives', $sStructureType = 'post_meta_box') {
