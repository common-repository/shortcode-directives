...
class ShortcodeDirectives_AdminPageFramework_View__Resource extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new ShortcodeDirectives_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new ShortcodeDirectives_AdminPageFramework_Format_PageResource_Script($asPageScript);
