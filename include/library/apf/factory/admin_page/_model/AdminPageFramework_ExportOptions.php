...
abstract class ShortcodeDirectives_AdminPageFramework_CustomSubmitFields extends ShortcodeDirectives_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class ShortcodeDirectives_AdminPageFramework_ExportOptions extends ShortcodeDirectives_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo ShortcodeDirectives_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
