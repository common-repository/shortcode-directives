...
class ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Filter extends ShortcodeDirectives_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
