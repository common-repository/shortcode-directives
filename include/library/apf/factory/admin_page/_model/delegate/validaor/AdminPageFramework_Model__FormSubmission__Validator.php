...
class ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator_Base extends ShortcodeDirectives_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator extends ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Link', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Import', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Export', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new ShortcodeDirectives_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
