...
class ShortcodeDirectives_AdminPageFramework_Property_admin_page extends ShortcodeDirectives_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'shortcode-directives') {
        ...
        $GLOBALS['aShortcodeDirectives_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aShortcodeDirectives_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aShortcodeDirectives_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
