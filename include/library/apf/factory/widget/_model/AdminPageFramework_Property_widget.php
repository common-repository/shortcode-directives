...
class ShortcodeDirectives_AdminPageFramework_Property_widget extends ShortcodeDirectives_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'shortcode-directives', $sStructureType) {
