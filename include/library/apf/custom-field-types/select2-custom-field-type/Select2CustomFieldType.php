...
if ( ! class_exists( 'ShortcodeDirectives_Select2CustomFieldType' ) ) :
/**
 ...
 */
class ShortcodeDirectives_Select2CustomFieldType extends ShortcodeDirectives_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.shortcode-directives-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.shortcode-directives-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.shortcode-directives-select-label' )
                .children( 'label' )
                .children( '.shortcode-directives-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.shortcode-directives-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.shortcode-directives-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.shortcode-directives-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.shortcode-directives-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .shortcode-directives-field-select2 > .shortcode-directives-select-label > label > .shortcode-directives-input-container {
    max-width: 84%;
}
