 ...
 * @package     ShortcodeDirectives_AdminPageFramework
 */

if ( ! class_exists( 'ShortcodeDirectives_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class ShortcodeDirectives_PostTypeTaxonomyCustomFieldType extends ShortcodeDirectives_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.shortcode-directives-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllShortcodeDirectives_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.shortcode-directives-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllShortcodeDirectives_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.shortcode-directives-field-post_type_taxonomy .shortcode-directives-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.shortcode-directives-field-post_type_taxonomy' );
    ...
    jQuery( '.shortcode-directives-field-post_type_taxonomy .shortcode-directives-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerShortcodeDirectives_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.shortcode-directives-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.shortcode-directives-field-post_type_taxonomy .select_all_button_container, 
.shortcode-directives-field-post_type_taxonomy .select_none_button_container
{
...
.shortcode-directives-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'shortcode-directives-loader' )
                    . "</label>"
                . "</div>";
