...
abstract class ShortcodeDirectives_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('ShortcodeDirectives_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new ShortcodeDirectives_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
