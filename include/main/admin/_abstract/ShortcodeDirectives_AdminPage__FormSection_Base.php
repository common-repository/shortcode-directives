 ...
 * @since       0.0.3
 */
abstract class ShortcodeDirectives_AdminPage__FormSection_Base extends ShortcodeDirectives_AdminPage__Element_Base {
    ...
    protected function _validate( $aInputs, $aOldInputs, $oAdminPage, $aSubmitInfo ) {
        ...
        if ( ! $_bVerified ) {
            ...
            $oAdminPage->setSettingNotice( __( 'There was something wrong with your input.', 'shortcode-directives' ) );
            return $aOldInputs;
        }
