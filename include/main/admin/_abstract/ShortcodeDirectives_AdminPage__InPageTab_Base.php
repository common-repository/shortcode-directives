 ...
 * @since       0.0.3
 */
abstract class ShortcodeDirectives_AdminPage__InPageTab_Base extends ShortcodeDirectives_AdminPage__Element_Base {
    ...
    protected function _doDebug( $oFactory ) {
        ...
        echo ShortcodeDirectives_AdminPageFramework_Debug::getDetails(
